...
async function init() {
    ...
    if (fetchedData) {
        ...
        if (!currentSelectedGameMode) {
            ...
            currentSelectedGameMode = gameModes.find(mode => mode.name == "Eliwood's Story");
